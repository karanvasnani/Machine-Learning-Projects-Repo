function [correctlyClassified, classificationErrors] = val_ReLU_2_layer(activationFunction, hiddenWeights_1, hiddenWeights_2, outputWeights, inputValues, labels)
